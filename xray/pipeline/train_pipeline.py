    ...
    def run_pipeline(self) -> None:
        ...
        try:
            ...
            print(
                ...
                f"{model_evaluation_artifact.model_accuracy:.2f}%"
            )

            # Building and pushing a container is an explicit deployment step,
            # not part of local model training.
            if os.getenv("PUSH_MODEL", "false").lower() == "true":
